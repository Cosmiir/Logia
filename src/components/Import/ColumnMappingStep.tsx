...
const FIELD_DEFINITIONS: FieldDefinition[] = [
  ...
  { key: 'experience_entries', labelKey: 'import.fields.experience_entries.label', required: false, group: 'status', icon: GripVertical, descKey: 'import.fields.experience_entries.desc' },
...
const AUTO_DETECT_PATTERNS: Record<string, string[]> = {
  ...
  experience_entries: ['experience entries', 'entries', 'versions', 'expériences'],
