...
const ProgressionWithDatesCard: React.FC<{
  ...
  experienceEntries?: import('@/types').ExperienceEntry[];
  dateLabel?: string | null;
  replayDateLabel?: string | null;
}> = ({ current, total, progressStatus, progressionLabel, pluralWithS, experienceDate, experienceEntries, dateLabel, replayDateLabel }) => {
...
const Lightbox: React.FC<{
  ...
  return (
    <div data-escape-to-close className="fixed inset-0 z-[100] flex flex-col" style={{ background: 'rgba(0,0,0,0.96)' }}>
      <div
        ref={wheelRef}
